...
if __name__ == '__main__':
    ...
    model = Darknet(my_params.project_patch + 'yolo\\cfg\\yolov3-obj.cfg')
    model.load_weights(my_params.project_patch + 'yolo\\weights\\yolov3-obj.weights')
    ...
    for line in timestamps_file:
        ...
        classes = load_classes(my_params.yolo_data + 'obj.names')
