...
if __name__ == "__main__":
    ...
    open3d.visualization.RenderOption.background_color = np.array([0.1529, 0.1569, 0.1333], np.float32)

    # render_option.point_color_option = open3d.PointColorOption.ZCoordinate
    open3d.visualization.RenderOption.point_color_option = open3d.PointColorOption.ZCoordinate
